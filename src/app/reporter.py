...
class InvestmentReporter:
    ...
    def _initialize_generators(self):
        self.generators = {
            ...
            "option_trade": OptionTradeReportGenerator(
                self.writers["option_trade_csv"]
            ),
            "option_summary": OptionSummaryReportGenerator(
                self.writers["option_summary_csv"]
            ),
            "final_summary": FinalSummaryReportGenerator(
                self.writers["final_summary_csv"]
            ),
        }
    ...
    def _calculate_trading_summary(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        option_summary = calculator.calculate_option_summary_details(
